    ...
    var tierApps: [ToolboxTierApp] {
        ...
        case .phPaper: // Tier 4
            return [
                ...
                ToolboxTierApp(title: "ICS Collaborative Map", subtitle: "Shared operational map sessions for commanders, operators, and observers", symbolName: "person.3", launchKind: .bundledWeb(path: "apps/ics-collaborative-map/index.html"))
            ]
        }
    }
}
    ...
    var body: some View {
        ZStack {
            ...
            GeometryReader { proxy in
                ...
                VStack(spacing: max(2, height * 0.004)) {
                    Text("The Hazmat Guys")
                        .font(.custom("Depressionist3Revisited", size: min(max(width * 0.032, 20), 34)))
                        .lineLimit(1)
                        .minimumScaleFactor(0.7)
                    Text("Hazmat ToolK.I.T.")
                        .font(.custom("Depressionist3Revisited", size: min(max(width * 0.020, 12), 20)))
                        .lineLimit(1)
                ...
                ForEach(Array(modules.enumerated()), id: \.element.id) { index, module in
                    ...
                    Button {
                        ...
                        let badgeHeight = min(zoneRect.height * 0.62, 34)
                        let lockBadgeHeight = min(zoneRect.height * 0.56, 30)
                        ZStack {
                            ...
                            .frame(width: zoneRect.width * 0.57, height: badgeHeight, alignment: .leading)
                            .background(
                                LinearGradient(
                            ...
                            HStack {
                                ...
                                Image(systemName: isUnlocked(module) ? "lock.open.fill" : "lock.fill")
                                    ...
                                    .foregroundStyle(.white)
                                    .frame(minWidth: 34, minHeight: lockBadgeHeight)
                                    .background(
                        ...
                        .padding(.horizontal, zoneRect.width * 0.012)
                    }
                    .buttonStyle(.plain)
