...
private struct ControlsPanel: View {
    ...
    @State private var isFlameExpanded = true
    @State private var isSmokeExpanded = false
        ...
        GeometryReader { proxy in
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: compact ? 12 : 14) {
                    ...
                    particleEditorSection(compact: compact)
                }
    ...
    private func particleEditorSection(compact: Bool) -> some View {
        VStack(alignment: .leading, spacing: compact ? 8 : 10) {
            ViewThatFits(in: .horizontal) {
                HStack {
...
private struct SpriteEmitterTuningSection: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: compact ? 6 : 8) {
            SliderField(labels.birthRate, value: $birthRate, range: 0...800, step: 1, format: "%.0f", compact: compact)
            SliderField(labels.lifetime, value: $lifetime, range: 0.05...5.0, step: 0.01, format: "%.2f", compact: compact)
            SliderField(labels.lifetimeRange, value: $lifetimeRange, range: 0...3.0, step: 0.01, format: "%.2f", compact: compact)
            SliderField(labels.speed, value: $speed, range: 0...300, step: 1, format: "%.0f", compact: compact)
            SliderField(labels.speedRange, value: $speedRange, range: 0...300, step: 1, format: "%.0f", compact: compact)
            SliderField(labels.xAcceleration, value: $xAcceleration, range: -300...300, step: 1, format: "%.0f", compact: compact)
            SliderField(labels.yAcceleration, value: $yAcceleration, range: -300...300, step: 1, format: "%.0f", compact: compact)
            SliderField(labels.emissionAngleDegrees, value: $emissionAngleDegrees, range: -180...180, step: 1, format: "%.0f", compact: compact)
            SliderField(labels.emissionAngleRangeDegrees, value: $emissionAngleRangeDegrees, range: 0...180, step: 1, format: "%.0f", compact: compact)
            SliderField(labels.positionRangeX, value: $positionRangeX, range: 0...120, step: 1, format: "%.0f", compact: compact)
            SliderField(labels.positionRangeY, value: $positionRangeY, range: 0...120, step: 1, format: "%.0f", compact: compact)
            SliderField(labels.scale, value: $scale, range: 0.01...1.5, step: 0.01, format: "%.2f", compact: compact)
            SliderField(labels.scaleRange, value: $scaleRange, range: 0...1.5, step: 0.01, format: "%.2f", compact: compact)
            SliderField(labels.scaleSpeed, value: $scaleSpeed, range: -3...3, step: 0.01, format: "%.2f", compact: compact)
            SliderField(labels.alpha, value: $alpha, range: 0...1, step: 0.01, format: "%.2f", compact: compact)
            SliderField(labels.alphaRange, value: $alphaRange, range: 0...1, step: 0.01, format: "%.2f", compact: compact)
            SliderField(labels.alphaSpeed, value: $alphaSpeed, range: -3...3, step: 0.01, format: "%.2f", compact: compact)
            SliderField(labels.colorBlendFactor, value: $colorBlendFactor, range: 0...1, step: 0.01, format: "%.2f", compact: compact)
        }
        .hazmatPanel()
    }
}
...
final class FLAFlameSimulationStore: ObservableObject {
    ...
    private let backgroundRotationKey = "Flaminator9000.backgroundRotationDegrees"
